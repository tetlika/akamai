...
def tree_compare(file1, file2):
    ...
    functions.t_write(compare_simple_types(content1, content2, int, str), "%s_report" % file1)
    functions.t_write(compare_simple_types(content2, content1, int, str), "%s_report" % file2)
    functions.t_write(compare_dict_keys(content1, content2), "%s_report" % file1, openmode='a')
    functions.t_write(compare_dict_keys(content2, content1), "%s_report" % file2, openmode='a')
    functions.t_write(compare_dict_deep(content1, content2), "%s_report" % file1, openmode='a')
    functions.t_write(compare_dict_deep(content2, content1), "%s_report" % file2, openmode='a')
